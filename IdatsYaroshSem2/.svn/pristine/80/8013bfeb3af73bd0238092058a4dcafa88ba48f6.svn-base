...
import collection.SortCollection;
import therapy.Term;
...
public class FXMLDocumentController implements Initializable {
    ...
    private DoubleList<Term> listOfTerms = new AbstrDoubleList<>();
    private Sprava spravaTerapeutu = new SpravaTerapeutu();
    ...
    private void refreshTerms(final DoubleList<Term> abstrDoubleList) {
    ...
    private void sortCollection(ActionEvent event) {
        listView.getItems().clear();
        SortCollection.sortCollection(listOfTerms);
